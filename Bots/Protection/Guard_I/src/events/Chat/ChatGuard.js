...
let küfürler = ["allahoc","allahoç","allahamk","allahaq","0r0spuc0cu","4n4n1 sk3r1m","p1c","@n@nı skrm","evladi","orsb","orsbcogu","amnskm","anaskm","oc","abaza","abazan","ag",
...
client.on('messageUpdate', async (oldMessage, newMessage) => {
    ...
    if (newMessage.channel.id == ["photo-chat","konser-chat"] && newMessage.attachments.size < 1) await newMessage.delete();
